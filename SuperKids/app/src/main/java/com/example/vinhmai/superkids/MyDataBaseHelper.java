...
////
////    public void addInformation(Objects object){
...
////            cursor.moveToFirst();
////
////        Objects object = new Objects(Integer.parseInt(cursor.getString(0))
////                ,cursor.getString(1)
////                ,cursor.getString(2)
////                , cursor.getString(3)
////                , cursor.getInt(4));
...
////    }
////
////    public List<Objects> getAllObject(){
////
////        List<Objects> objectListlist = new ArrayList<Objects>();
...
////                object.setSound(cursor.getString(3));
////                object.setTopicId(Integer.parseInt(cursor.getString(4)));
////
////                Objects object1 = new Objects(Integer.parseInt(cursor.getString(0))
////                        ,setWord(cursor.getString(1))
////                        ,setImage(cursor.getString(2))
////                        ,setSound(cursor.getString(2))
////                        ,setTopicId(cursor.getString(2)));
////
